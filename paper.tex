...
norm. In Euclidean norm, the processing time is longer, and data with slight changes using more processing time with comparing result of walking data and running data.
\begin{table}[]
   \begin{subfigure}{\columnwidth}
   \centering
