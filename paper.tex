...
\State k = 1 ; j = 1
\State lp = $y^1_1 - \epsilon$ \Comment{low point}
\State hp = $y^1_1 + \epsilon$ \Comment{high point}
%\Function{line}{$x$, ($x_0$, $y_0$), ($x_1$, $y_1$)} 
% \Comment{Return the ordinate of the line defined by $(x_0, y_0)$, $(x_1, y_1)$ at abscissa $x$.}
%\Return $y_0 + \frac{y_1-y_0}{x_1-x_0}(x-x_0)$
%\EndFunction
