...
consumes 1.4 times more memory than 2D (1.3 times on average for
Euclidean norm), and processing time is 1.2 longer (1.13 on
...
close to 20\% for the walking activity, which is substantial.
...
%~ We also measured the compression latency on Neblina for this experiment.
%~ The maximal measured latency was 7.56~ms, obtained for the Euclidean distance 
%~ on the walk data, finish this if the correct values are avail.
